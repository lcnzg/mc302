...
public class Lacaio extends Carta implements ILaMaSerializable{
	...
	public void escreveAtributos(Escritor fw) throws IOException {
		...
		fw.escreveAtributo("Vida Atual", String.valueOf(getVidaAtual()));
		fw.escreveAtributo("Vida Maxima", String.valueOf(getVidaMaxima()));
		fw.escreveAtributo("Habilidade", getHabilidade().toString());		
		fw.escreveDelimObj("Lacaio");
		fw.finalizar();
	}
}