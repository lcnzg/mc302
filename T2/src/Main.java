...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException  {
		...
		// Saida de arquivo
		PrintWriter saidaArquivo = new PrintWriter("log.txt");
		
		// Funcionalidade ativas: nenhuma
		//EnumSet<Funcionalidade> funcionalidades = EnumSet.noneOf(Funcionalidade.class);
		
		EnumSet<Funcionalidade> funcionalidades = EnumSet.of(Funcionalidade.INVESTIDA);
		...
		//multiplasPartidas(baralho1, baralho2, verbosidade, tempoLimite, saidaArquivo, funcionalidades, 1000);
	}
	...
	private static void umaPartida(Baralho baralho1, Baralho baralho2, int verbosidade, int tempoLimite, PrintWriter saidaArquivo, EnumSet<Funcionalidade> funcionalidades){
		...
		Motor partida = new MotorRA151106(baralho1, baralho2, Mao1, Mao2, jogA, jogB, verbosidade, tempoLimite, saidaArquivo, funcionalidades);
